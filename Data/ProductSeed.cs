...
{
    /// <summary>
    /// Seed Product (metadata). Price / ListPrice / Inventory nằm trong
    /// ProductVariantSeed (chạy ngay sau ProductSeed).
    /// </summary>
    public static class ProductSeed
    {
        /// <summary>
        /// Tuple mô tả 1 product cho seed. Field `price`, `listPrice`, `specs`
        /// sẽ được consume bởi ProductVariantSeed qua property SeedData.
        /// </summary>
        public record ProductSeedRow(
            int Id, string Name, decimal Price, decimal? ListPrice,
            int CategoryId, int BrandId, int WarrantyPolicyId,
            string Specs, string ImgFolder, string ImgFile, int Status);

        /// <summary>Public để ProductVariantSeed đọc lại (single source of truth).</summary>
        public static readonly ProductSeedRow[] Rows = BuildRows();
            ...
            try
            {
                ...
                foreach (var r in Rows)
                {
                    context.Products.Add(new Product
                    {
                        ...
                        BrandId          = r.BrandId,
                        WarrantyPolicyId = r.WarrantyPolicyId,
                        Status           = r.Status,
                        Specifications   = r.Specs,
                        Description      = BuildDescription(r.Name),
                    ...
                    {
                        ProductId = r.Id,
                        ImageUrl  = $"{r.ImgFolder}/{r.ImgFile}",
                        IsDefault = true,
                        CreatedAt = now
                    });
                }
        ...
        /// <summary>Slug URL-friendly: bỏ dấu, thường hoá, thay space bằng '-', append ID.</summary>
        ...
        // ── Dataset ───────────────────────────────────────────────
        private static ProductSeedRow[] BuildRows() => new[]
        {
            // ── LAPTOP (1-10) ────────────────────────────────────────
            new ProductSeedRow(1,  "Dell XPS 13 Plus - Core i7 Gen 13", 26_990_000, 29_990_000,
                SeedConstants.CatLaptop, SeedConstants.BrandDell, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(2,  "ASUS VivoBook 15X - Ryzen 7 5700U", 14_990_000, 17_500_000,
                SeedConstants.CatLaptop, SeedConstants.BrandAsus, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(3,  "Lenovo ThinkPad X1 Carbon Gen 12", 34_990_000, 38_000_000,
                SeedConstants.CatLaptop, SeedConstants.BrandLenovo, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(4,  "MacBook Air M3 2024 - 16GB/512GB", 32_990_000, null,
                SeedConstants.CatLaptop, SeedConstants.BrandApple, SeedConstants.WarrantyStd12,
            ...
            new ProductSeedRow(5,  "HP Pavilion 15 - Core i5 Gen 13", 13_490_000, 15_990_000,
                SeedConstants.CatLaptop, SeedConstants.BrandDell, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(6,  "Acer Aspire 5 A515 - Ryzen 5 5500U", 11_990_000, 13_500_000,
                SeedConstants.CatLaptop, SeedConstants.BrandAcer, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(7,  "ASUS VivoBook Pro 16 - Ryzen 9 5900HX", 22_990_000, 26_000_000,
                SeedConstants.CatLaptop, SeedConstants.BrandAsus, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(8,  "Lenovo IdeaPad Slim 5i - Core i7 13th", 16_490_000, 18_990_000,
                SeedConstants.CatLaptop, SeedConstants.BrandLenovo, SeedConstants.WarrantyStd24,
            ...
            // ── LAPTOP GAMING (11-20) ─────────────────────────────────
            new ProductSeedRow(11, "ASUS ROG Strix G16 2024 - RTX 4090", 54_990_000, 62_000_000,
                SeedConstants.CatLaptopGaming, SeedConstants.BrandAsus, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(12, "MSI Katana 17 B13V - RTX 4070", 29_990_000, 34_000_000,
                SeedConstants.CatLaptopGaming, SeedConstants.BrandMsi, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(13, "Acer Predator Helios 18 2024 - RTX 4080", 45_990_000, 52_000_000,
                SeedConstants.CatLaptopGaming, SeedConstants.BrandAcer, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(14, "Lenovo Legion Pro 7i Gen 9 - RTX 4090", 62_990_000, 72_000_000,
                SeedConstants.CatLaptopGaming, SeedConstants.BrandLenovo, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(15, "ASUS TUF Gaming A15 2024 - RTX 4070", 26_990_000, 30_000_000,
                SeedConstants.CatLaptopGaming, SeedConstants.BrandAsus, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(16, "MSI Raider GE78 HX 2024 - RTX 4080", 42_990_000, 48_000_000,
                SeedConstants.CatLaptopGaming, SeedConstants.BrandMsi, SeedConstants.WarrantyStd24,
            ...
            // ── PC GVN (21-26) ────────────────────────────────────────
            new ProductSeedRow(21, "PC Gaming GVN RTX 4060 - Mid Range", 28_990_000, 32_000_000,
                SeedConstants.CatPcGvn, SeedConstants.BrandAsus, SeedConstants.WarrantyStd12,
            ...
            new ProductSeedRow(22, "PC Gaming GVN RTX 5080 - High End", 68_990_000, 75_000_000,
                SeedConstants.CatPcGvn, SeedConstants.BrandMsi, SeedConstants.WarrantyStd12,
            ...
            new ProductSeedRow(23, "PC Gaming GVN RTX 5090 - Extreme", 155_000_000, 170_000_000,
                SeedConstants.CatPcGvn, SeedConstants.BrandAsus, SeedConstants.WarrantyStd12,
            ...
            // ── COMPONENTS (27-36) ────────────────────────────────────
            new ProductSeedRow(27, "ASUS ROG STRIX Z890-E Gaming WiFi", 9_990_000, 11_500_000,
                SeedConstants.CatMainCpuVga, SeedConstants.BrandAsus, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(28, "Intel Core Ultra 9 285K - 24 Cores", 14_990_000, 17_000_000,
                SeedConstants.CatMainCpuVga, SeedConstants.BrandIntel, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(29, "NVIDIA RTX 5090 - 32GB GDDR7 Founders", 92_990_000, 99_000_000,
                SeedConstants.CatMainCpuVga, SeedConstants.BrandNvidia, SeedConstants.WarrantyStd24,
                "VRAM: 32GB GDDR7 | CUDA Cores: 21760 | Memory Bus: 576-bit | TDP: 575W | PCIe: 5.0 | DLSS 4: Có",
                "components", "gpu-rtx-5090-front.jpg", 1),

            new ProductSeedRow(30, "NVIDIA RTX 5080 - 16GB GDDR7", 49_990_000, 55_000_000,
                SeedConstants.CatMainCpuVga, SeedConstants.BrandNvidia, SeedConstants.WarrantyStd24,
                "VRAM: 16GB GDDR7 | CUDA Cores: 10752 | Memory Bus: 256-bit | TDP: 360W | PCIe: 5.0 | DLSS 4: Có",
                "components", "gpu-rtx-5080-front.jpg", 1),

            new ProductSeedRow(31, "Samsung 990 Pro NVMe 2TB", 4_990_000, 5_990_000,
                SeedConstants.CatStorageRam, SeedConstants.BrandSamsung, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(32, "Corsair Dominator Titanium 32GB DDR5", 4_490_000, 5_200_000,
                SeedConstants.CatStorageRam, SeedConstants.BrandCorsair, SeedConstants.WarrantyStd24,
                "Dung lượng: 32GB (2x16GB) | Speed: 6000MHz | CAS: CL30 | Type: DDR5 | Voltage: 1.35V | RGB: Có",
                "storage", "ram-corsair-dominator-box.jpg", 1),

            new ProductSeedRow(33, "Kingston FURY Beast 64GB DDR5 6000MHz", 8_990_000, 10_500_000,
                SeedConstants.CatStorageRam, SeedConstants.BrandKingston, SeedConstants.WarrantyStd24,
                "Dung lượng: 64GB (2x32GB) | Speed: 6000MHz | CAS: CL36 | Type: DDR5 | Voltage: 1.4V | Intel XMP: Có",
                "storage", "ram-kingston-fury-box.jpg", 1),

            // ── PERIPHERALS (37-50) ───────────────────────────────────
            new ProductSeedRow(37, "Logitech G Pro X Superlight 2 DEX", 2_990_000, 3_490_000,
                SeedConstants.CatChuot, SeedConstants.BrandLogitech, SeedConstants.WarrantyStd12,
            ...
            new ProductSeedRow(38, "Razer Viper V3 Pro - 30K DPI", 2_490_000, 2_990_000,
                SeedConstants.CatChuot, SeedConstants.BrandRazer, SeedConstants.WarrantyStd12,
            ...
            new ProductSeedRow(39, "AKKO MOD007B PC HE - Magnetic Switch", 2_790_000, 3_290_000,
                SeedConstants.CatBanPhim, SeedConstants.BrandAkko, SeedConstants.WarrantyStd12,
            ...
            new ProductSeedRow(40, "Corsair K100 Air Wireless - Cherry MX", 5_490_000, 6_500_000,
                SeedConstants.CatBanPhim, SeedConstants.BrandCorsair, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(41, "HyperX Cloud III Wireless - 7.1 Surround", 2_790_000, 3_290_000,
                SeedConstants.CatTaiNghe, SeedConstants.BrandHyperX, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(42, "SteelSeries Arctis Nova Pro Wireless", 6_990_000, 7_990_000,
                SeedConstants.CatTaiNghe, SeedConstants.BrandSteelSeries, SeedConstants.WarrantyStd24,
            ...
            // ── MONITORS (61-70) ──────────────────────────────────────
            new ProductSeedRow(61, "LG UltraGear 27GP850-B - 27\" 1440p 165Hz", 9_490_000, 10_990_000,
                SeedConstants.CatManHinh, SeedConstants.BrandLg, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(62, "ASUS ROG Swift Pro PG248QP - 540Hz", 14_990_000, 17_000_000,
                SeedConstants.CatManHinh, SeedConstants.BrandAsus, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(63, "Samsung Odyssey G9 Neo 2024 - 57\" DQHD 240Hz", 38_990_000, 45_000_000,
                SeedConstants.CatManHinh, SeedConstants.BrandSamsung, SeedConstants.WarrantyStd24,
            ...
            new ProductSeedRow(64, "BenQ MOBIUZ EX2710U - 27\" 4K 144Hz", 14_490_000, 16_500_000,
                SeedConstants.CatManHinh, SeedConstants.BrandBenq, SeedConstants.WarrantyStd24,
