/* ========== Banner Create - Image Upload Handler ========== */
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const form = document.querySelector('#bannerCreateForm');
    ...
    if (bannerTypeSelect) {
        bannerTypeSelect.addEventListener('change', (e) => {
            ...
            document.getElementById('previewType').textContent = typeMap[e.target.value] || '—';
        });
    }
