...
namespace HDKTech.Models
{
    public class CheckoutViewModel
    {
        ...
        /// <summary>
        /// Mã giảm giá — người dùng nhập, server validate.
        /// </summary>
        [StringLength(50, ErrorMessage = "Mã giảm giá không được quá 50 ký tự")]
        [Display(Name = "Mã giảm giá")]
        public string? PromoCode { get; set; }

        // ── Read-only summary — KHÔNG bind từ form POST ──────────────────────
        /// <summary>
        /// Phí vận chuyển tính server-side — [BindNever] ngăn client tamper.
        /// </summary>
        [BindNever]
        public decimal ShippingFee { get; set; }

        /// <summary>
        /// Số tiền giảm giá — tính server-side.
        /// </summary>
        [BindNever]
        ...
        [BindNever]
        public decimal TongCong => TotalAmount + ShippingFee - Discount;
        ...
        /// <summary>Message thông báo kết quả áp mã giảm giá (hiển thị trên View).</summary>
        [BindNever]
